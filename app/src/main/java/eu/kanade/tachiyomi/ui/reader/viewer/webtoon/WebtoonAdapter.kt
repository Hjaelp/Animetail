 ...
 */
class WebtoonAdapter(val viewer: WebtoonViewer, private val translationManager: TranslationManager = Injekt.get()) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
